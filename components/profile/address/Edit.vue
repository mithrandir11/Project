...
<template>
    ...
    <button @click="showModal = true"  type="button" class=" btn-custom inline-flex  items-center gap-x-1  text-sm">
        ویرایش
        ...
        <div class="fixed inset-0 z-10 w-screen ">
            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white  shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 max-h-screen overflow-y-auto">
                    ...
                    <div class="flex items-center justify-between py-2  rounded-t">
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 sm:mt-0 pt-6 w-full">
